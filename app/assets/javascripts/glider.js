    ...
    '$document', function($document) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          if ((scope.values != null) && (scope.values() != null)) {
            scope.parsedValues = scope.values().split(',').map(function(el) {
              return parseInt(el);
            });
          }
          ...
          snap = function() {
            var closestValue, diff, minDiff, snapValue, value, _i, _j, _len, _len1, _ref, _ref1;
            if (scope.increments) {
              minDiff = Infinity;
          ...
          scope.step = function(steps) {
            ...
            doValueStep = function(steps) {
              var index, newVal;
              index = steps > 0 ? _.findIndex(scope.parsedValues, function(el) {
                return el >= scope.value;
              }) : _.findLastIndex(scope.parsedValues, function(el) {
                return el <= scope.value;
              });
              if (index === -1) {
                index = 0;
